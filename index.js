/*
 ...
 Copyright (C) 2014-2015 Marcel Erz
...
var assert = require('assert'), PNGImage = require('pngjs-image'), LPyramid = require('./lib/lpyramid.js'), metrics = require('./lib/metric.js'), Promise = require('promise');
...
PerceptualDiff.prototype = {
	...
	getInfo: function () {
		var thresholdType = (this.thresholdType === PerceptualDiff.THRESHOLD_PIXEL ? 'px' : '%'), result = [];
	...
	_quickIdentical: function (dim) {
		var diff = 0, i, x, y, width, height, outputImageHasImage = this.copyImageAToOutput || this.copyImageBToOutput, outputMaskOpacity = outputImageHasImage ? this.outputMaskOpacity : undefined, outputBackgroundOpacity = outputImageHasImage ? this.outputBackgroundOpacity : undefined;
	...
	_yee_compare: function (fn) {
		var i, ii, resultA, resultB, r, g, b, w, h, dim, diffPixel, a_lum, b_lum, ab, da, db, la, lb, x, y, outputImageHasImage = this.copyImageAToOutput || this.copyImageBToOutput, outputMaskOpacity = outputImageHasImage ? this.outputMaskOpacity : undefined, outputBackgroundOpacity = outputImageHasImage ? this.outputBackgroundOpacity : undefined;
